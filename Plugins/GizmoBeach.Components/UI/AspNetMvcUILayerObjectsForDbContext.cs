...
{
    public class AspNetMvcUILayerObjectsForDbContext : RenderBase, IUIObjects
    {
        #region ctors
        ...
        public AspNetMvcUILayerObjectsForDbContext(RequestContext context):this(context, null)
        {

        }

        public AspNetMvcUILayerObjectsForDbContext(RequestContext context, IAutoMapperFramework autoMapperFramework)
...
_output.autoTabLn("}");
        ...
        private void BuildControllerCodeTemplate()
        {
            ...
            ICodeTemplateBuilder builder = new KingsMvcServiceLibraryCodeTemplatesForDbContext(_context, false, useDtos);

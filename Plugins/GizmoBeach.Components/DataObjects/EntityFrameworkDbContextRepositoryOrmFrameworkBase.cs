...
{
    public class EntityFrameworkDbContextRepositoryOrmFrameworkBase : RenderBase, IORMFramework
    {
        private readonly EFCriteria _criteria;
        ...
        public EntityFrameworkDbContextRepositoryOrmFrameworkBase(IDataStore dataStore, RequestContext context)
            :this(dataStore, context, new EFCriteria()) 
        {
